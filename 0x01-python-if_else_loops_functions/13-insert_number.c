...
/**
 * add_nodeint - a function to add a new node at the beginning of a listint_t list
...
/**
 * insert_nodeint_at_index - a function to insert a new node at a given position
 * @head: Head of the list
 * @idx: Index
